...
const dsn = "root:0000@(localhost:3306)/livedata?charset=utf8mb4&parseTime=True&loc=Local"
...
func main() {
	...
	dataMap := map[string]func(detailType gorm.ColumnType) (dataType string){
		...
		"decimal":   func(detailType gorm.ColumnType) (dataType string) { return "float64" },   // 金额类型全部转换为第三方库,github.com/shopspring/decimal
	}
	// 要先于`ApplyBasic`执行
