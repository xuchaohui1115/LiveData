...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.Keyword = field.NewString(tableName, "keyword")
	...
	_role.Creator = field.NewString(tableName, "creator")
...
type role struct {
	...
	Desc      field.String
	Status    field.Int64 // '1正常, 2禁用'
	Sort      field.Int64 // '角色排序(排序越大权限越低, 不能查看比自己序号小的角色, 不能编辑同序号用户权限, 排序为1表示超级管理员)'
